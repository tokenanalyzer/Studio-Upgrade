...
// PORT/BASE_PATH are only needed to run the dev/preview server (e.g. on
// Replit); `vite build` doesn't use them, so fall back to defaults instead
// of failing builds on platforms like Vercel that don't set them.
